...
if page == "Home":
    ...
    # Student Details
    name = st.text_input("Your Name", "GIRAMAHORO Isaac")
...
# Projects section
    ...
    milestones = [
        ...
        "💼 In 2025: Achieved the project on how AI is changing the world of today",
    ...
    project_data = {
        ...
        "Dissertation": {
            "🌍 Basic AI Tutoring System for MATH Education": {
                ...
                "link": "https://github.com/umuhuzaassoumpta/Dissertation"
            }
        }
    }
...
# Contact Page
    ...
    st.title("📬 Contact Me")
    st.write("📧 Email: giramahoroisaac4@gmail.com")
    st.write("🔗 [LinkedIn](https://www.linkedin.com/in/giramahoro-isaac-205651251/)")
